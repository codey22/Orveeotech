          ...
          <div className="flex flex-wrap gap-8 max-md:flex-col">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-6 mt-2">
                <a href="#" aria-label="Facebook" className="text-[#1a1a1a] bg-[#eccc68] transition-all duration-300 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] inline-flex items-center justify-center no-underline p-0 w-[45px] h-[45px] rounded-full border-2 border-[#1a1a1a] shadow-[3px_3px_0px_rgba(0,0,0,0.5)] hover:-translate-y-[5px] hover:rotate-10 hover:bg-[#ff4757] hover:text-white hover:shadow-[5px_5px_0px_rgba(0,0,0,0.5)]">
